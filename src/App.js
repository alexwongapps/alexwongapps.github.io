        ...
        <div>
            ...
            <div className="cards">
                ...
                <div className="rowCards">
                    ...
                    <AppCard name="Mental Math" color="#AABAFF" icon={mentalmathIcon} iosLink="https://apps.apple.com/us/app/mental-math-quick-math-game/id1448312088" androidLink="https://play.google.com/store/apps/details?id=com.alexwongapps.mentalmath" tagline="A fun, simple math game; follow the operations and get the right answer." descriptions={["3 difficulty levels change the speed of the game", "Each game gets progressively harder, with larger answers and more operations", "Each game is randomly generated throughout gameplay", "Group Mode uses Bluetooth to allow users to compete against each other for the highest score"]} />
                </div>
            </div>
        </div>
    );
